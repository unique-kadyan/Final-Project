...
pygame.display.set_caption('Tanks :- Game Developed by Er. Rajesh Singh Kadyan')
...
def fireShell(xy, tankx, tanky, turPos, gun_power, xlocation, barrier_width, randomHeight, enemyTankX, enemyTankY):
    #pygame.mixer.Sound.play("fire.wav")
    playsound('fire.wav')
    fire = True
    damage = 0
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Developed by :- Er. Rajesh Singh Kadyan", wheat, 280)
...
def game_over():
    ...
    while game_over:
        ...
        message_to_screen("ohh! So Sad , You died.", wheat, -30)
